@extends('layouts.app')
@section('title', 'Purchase Invoices | New')
        ...
        <form action="{{ route('purchase_invoices.store') }}" method="POST"
            ...
            <section class="card">
                <header class="card-header d-flex justify-content-between align-items-center">
                    <h2 class="card-title mb-0">New Purchase Invoice</h2>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="bill_no" class="form-control"
                                   value="{{ old('bill_no') }}" placeholder="Supplier bill #">
                        </div>
                        <div class="col-md-2">
                            <label>Ref No</label>
                            <input type="text" name="ref_no" class="form-control"
                                   value="{{ old('ref_no') }}" placeholder="Reference">
                        </div>
                        <div class="col-md-2">
                    ...
                    <table class="table table-bordered table-sm" id="itemsTable">
                        ...
                        <tbody id="itemsBody">
                            <tr>
                                ...
                                <td><input type="number" name="items[0][quantity]"     class="form-control qty"   step="any" min="0.01" placeholder="0.00" required></td>
                                <td><input type="number" name="items[0][price]"        class="form-control price" step="any" min="0"    placeholder="0.00" required></td>
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="convance_charges" id="conveyance"
                                   class="form-control" step="any" min="0" value="{{ old('convance_charges', 0) }}">
                        </div>
                        <div class="col-md-2">
                            <label>Labour</label>
                            <input type="number" name="labour_charges" id="labour"
                                   class="form-control" step="any" min="0" value="{{ old('labour_charges', 0) }}">
                        </div>
                        <div class="col-md-2">
                            <label>Discount</label>
                            <input type="number" name="bill_discount" id="discount"
                                   class="form-control" step="any" min="0" value="{{ old('bill_discount', 0) }}">
                        </div>
...
// ── Build product options (filtered by selected vendor) ───────────────
...
// ── Refresh all product dropdowns when vendor changes ─────────────────
...
// ── Vendor change → refresh all product selects ───────────────────────
